        ...
        <div className='flex flex-grow justify-between flex-col ml-12 mb-4'>
            <div className='flex flex-row mt-4'>
                ...
                <div className='flex flex-col xl:ml-8 grow'>
                    ...
                    <Textarea isRequired rows="3" value={description} className='w-2/3 text-lg' placeholder="Contanos sobre los horarios de disponibilidad y danos una breve descripción del servicio que ofreces." onChange={e => setDescripcion(e.target.value)}/>
